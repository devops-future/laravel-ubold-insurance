            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">@lang('menus.add new policies')</li>
                    </ol>
                </div>
                <h4 class="page-title">@lang('menus.add new policies')</h4>
            </div>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
            <form id="add_form" method="post" action="{{ route('policies.store') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div id="rootwizard">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="chassis" name="chassis" class="form-control" value="" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                        <label class="col-md-3 col-form-label" for="enrollment">@lang('policies.enrollment')</label>
                                        <div class="col-md-9">
                                            <input type="text" id="enrollment" name="enrollment" class="form-control" value="" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="circulation" name="circulation" class="form-control" value="" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="ndoor" name="ndoor" class="form-control" value="" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="condition" name="condition" class="form-control" value="" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                        <label class="col-md-3 col-form-label" for="risk">@lang('policies.risk')</label>
                                        <div class="col-md-9">
                                            <input type="text" id="risk" name="risk" class="form-control" value="" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                        <label class="col-md-3 col-form-label" for="passengers">@lang('policies.passengers')</label>
                                        <div class="col-md-9">
                                            <input type="text" id="passengers" name="passengers" class="form-control" value="" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                        <label class="col-md-3 col-form-label" for="cylinders">@lang('policies.cylinders')</label>
                                        <div class="col-md-9">
                                            <input type="text" id="cylinders" name="cylinders" class="form-control" value="" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                        <label class="col-md-3 col-form-label" for="peso">@lang('policies.peso del vehiculo (toneladas)')</label>
                                        <div class="col-md-9">
                                            <input type="text" id="peso" name="peso" class="form-control" value="" required>
                                        </div>
                                    </div>
                                </div> <!-- end col -->
                            </div> <!-- end row -->
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-md-9">
                                            <select class="form-control" id="status_option" name="status" required>
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="create_date" name="create_date" class="form-control" value="{{ date('Y-m-d') }}" readonly="readonly">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                        <label class="col-md-3 col-form-label" for="activation_date">@lang('policies.activation date policy')</label>
                                        <div class="col-md-9">
                                            <input type="text" id="activation_date" name="activation_date" class="form-control" placeholder="" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                        <label class="col-md-3 col-form-label" for="star_date">@lang('policies.star date policy')</label>
                                        <div class="col-md-9">
                                            <input type="text" id="star_date" name="star_date" class="form-control" placeholder="" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                        <label class="col-md-3 col-form-label" for="final_date">@lang('policies.final date policy')</label>
                                        <div class="col-md-9">
                                            <input type="text" id="final_date" name="final_date" class="form-control" placeholder="" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                        <label class="col-md-3 col-form-label" for="policiesID">@lang('policies.policies id')</label>
                                        <div class="col-md-9">
                                            <input type="text" id="policiesID" name="policiesID" class="form-control" placeholder="" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                        <label class="col-md-3 col-form-label" for="external">@lang('policies.reference external')</label>
                                        <div class="col-md-9">
                                            <input type="text" id="external" name="external" class="form-control" placeholder="" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                        <label class="col-md-3 col-form-label" for="internal">@lang('policies.reference internal')</label>
                                        <div class="col-md-9">
                                            <input type="text" id="internal" name="internal" class="form-control" placeholder="" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                        <label class="col-md-3 col-form-label" for="amount">@lang('policies.financing amount')</label>
                                        <div class="col-md-9">
                                            <input type="text" placeholder="" id="amount" name="amount" data-a-sign="$ " class="form-control autonumber" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                        <label class="col-md-3 col-form-label" for="marketValue">@lang('parameters.market value')</label>
                                        <div class="col-md-9">
                                            <input type="text" placeholder="" id="marketValue" name="marketValue" data-a-sign="$ " class="form-control autonumber" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                        <label class="col-md-3 col-form-label" for="annual">@lang('policies.premium total annual')</label>
                                        <div class="col-md-9">
                                            <input type="text" placeholder="" id="annual" name="annual" data-a-sign="$ " class="form-control autonumber" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                        <label class="col-md-3 col-form-label" for="net">@lang('policies.premium net')</label>
                                        <div class="col-md-9">
                                            <input type="text" placeholder="" id="net" name="net" data-a-sign="$ " class="form-control autonumber" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                        <label class="col-md-3 col-form-label" for="month">@lang('policies.premium month')</label>
                                        <div class="col-md-9">
                                            <input type="text" placeholder="" id="month" name="month" data-a-sign="$ " class="form-control autonumber" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                        <label class="col-md-3 col-form-label" for="isc">@lang('policies.isc (16.0%)')</label>
                                        <div class="col-md-9">
                                            <input type="text" placeholder="" id="isc" name="isc" data-a-sign="$ " class="form-control autonumber" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                        <label class="col-md-3 col-form-label" for="plan">@lang('policies.payment plan')</label>
                                        <div class="col-md-9">
                                            <input type="text" placeholder="" id="plan" name="plan" data-v-max="99999999" data-v-min="0" class="form-control autonumber" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                        <div class="col-3">
