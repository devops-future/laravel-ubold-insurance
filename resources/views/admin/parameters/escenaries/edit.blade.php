            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">@lang('parameters.quote escenaries edit')</li>
                    </ol>
                </div>
                <h4 class="page-title">@lang('parameters.quote escenaries edit')</h4>
            </div>
        </div>
    </div>
    <div class="card">
        ...
        <div class="card-body">
            <form id="add_form" method="post" action="{{ URL::to('/escenaries/' . $data->id) }}">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                <div class="row">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-9">
                            <input value="{{ $data->compressive }}" data-a-sign="%" data-p-sign="s" class="form-control autonumber" id="compressive" name="compressive">
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <label class="col-md-3 col-form-label" for="deductibles">@lang('parameters.deductibles')</label>
                        <div class="col-md-9">
                            <input value="{{ $data->deductibles }}" class="form-control" id="deductibles" name="deductibles" />
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <label class="col-md-3 col-form-label" for="judicial">@lang('parameters.judicial deposit')</label>
                        <div class="col-md-9">
                            <input value="{{ $data->judicial }}" class="form-control" id="judicial" name="judicial" />
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <label class="col-md-3 col-form-label" for="civil">@lang('parameters.civil liability')</label>
                        <div class="col-md-9">
                            <input value="{{ $data->civil }}" class="form-control" id="civil" name="civil" />
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <label class="col-md-3 col-form-label" for="personal">@lang('parameters.personal accidents cond')</label>
                        <div class="col-md-9">
                            <input class="form-control" id="personal" name="personal" value="{{ $data->personal }}" />
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <label class="col-md-3 col-form-label" for="road">@lang('parameters.road')</label>
                        <div class="col-md-9">
                            <input class="form-control" id="road" name="road" value="{{ $data->road }}" />
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <label class="col-md-3 col-form-label" for="vehicle">@lang('parameters.vehicle')</label>
                        <div class="col-md-9">
                            <input class="form-control" id="vehicle" name="vehicle" value="{{ $data->vehicle }}" />
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <label class="col-md-3 col-form-label" for="motor">@lang('parameters.motor')</label>
                        <div class="col-md-9">
                            <input class="form-control" id="motor" name="motor" value="{{ $data->motor }}" />
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <label class="col-md-3 col-form-label" for="gasoline">@lang('parameters.gasoline')</label>
                        <div class="col-md-9">
                            <input class="form-control autonumber" data-v-min="0" id="gasoline" name="gasoline" value="{{ $data->gasoline }}" />
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <label class="col-md-3 col-form-label" for="gas">@lang('parameters.gas')</label>
                        <div class="col-md-9">
                            <input class="form-control autonumber" data-v-min="0" id="gas" name="gas" value="{{ $data->gas }}" />
                        </div>
                    </div>
